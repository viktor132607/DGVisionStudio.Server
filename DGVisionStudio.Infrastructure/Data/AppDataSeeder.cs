...
// The typo "porfolio" is intentional: it matches the committed client asset directory
// public/images/porfolio. This list mirrors the repository portfolio tree 1:1.
public static class AppDataSeeder
{
    ...
    private static readonly string[] EventBulgarePaths =
    {
        ...
        P + "events/bulgare/2.jpg",
        P + "events/bulgare/3.jpg",
    };
